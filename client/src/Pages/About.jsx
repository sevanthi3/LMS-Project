...
import aboutMainImage from "../asset/images/About.png";
      ...
      <div className="flex md:flex-row flex-col-reverse items-center justify-center md:gap-10 gap-7 w-full space-y-7">
        <div className="md:w-1/2 w-full space-y-7">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-200 font-nunito-sans">
            ...
            We are providing the platform for the aspiring teachers and students to share their skills,
            creativity and knowledge to each other to empower and contribute in the growth
